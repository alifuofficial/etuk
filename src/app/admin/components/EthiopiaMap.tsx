...
const CITY_GEO_COORDINATES: Record<string, [number, number]> = {
  ...
  "mojo": [8.5917, 39.1167],
  "sululta": [9.1833, 38.7500],
  "sebeta": [8.9167, 38.6167],
  "burayu": [9.0500, 38.6500],
  "weliso": [8.5333, 37.9667],
  "waliso": [8.5333, 37.9667],
  "butajira": [8.1167, 38.3667],
  "ambo": [8.9833, 37.8500],
  "fiche": [9.8000, 38.7333],
  "debre birhan": [9.6833, 39.5333],
  "debre berhan": [9.6833, 39.5333],
  "asella": [7.9500, 39.1167],
  "asela": [7.9500, 39.1167],
  ...
  "woldiya": [11.8333, 39.6000],
  "jijiga": [9.3500, 42.8000],
  "harar": [9.3111, 42.1278],
  "gambela": [8.2500, 34.5833],
  "asosa": [10.0667, 34.5333],
  "semera": [11.7917, 41.0000],
  "logia": [11.7333, 41.0000],
  "gode": [5.9500, 43.5500],
  "robe": [7.1333, 40.0000],
  "goba": [7.0167, 39.9833],
  "axum": [14.1333, 38.7167],
  "shire": [14.1000, 38.2833],
  "metu": [8.3000, 35.5833],
  "bedele": [8.4500, 36.3333],
  "dembi dolo": [8.5333, 34.8000],
  "gimbi": [9.1667, 35.8333],
  "assayita": [11.5833, 41.4333],
  "metema": [12.9667, 36.1667],
  "humera": [14.3000, 36.6167],
  "maychew": [12.7833, 39.5333],
  "alamata": [12.4167, 39.5500],
  "korem": [12.5000, 39.5167],
  "negele borana": [5.3333, 39.5833],
